  ...
  _createClass(ChipInput, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          alwaysShowPlaceholder = _props.alwaysShowPlaceholder,
          required = _props.required,
          rootRef = _props.rootRef,
          value = _props.value,
          variant = _props.variant,
          other = _objectWithoutProperties(_props, ['allowDuplicates', 'blurBehavior', 'children', 'chipRenderer', 'classes', 'className', 'clearInputValueOnChange', 'defaultValue', 'dataSource', 'dataSourceConfig', 'disabled', 'disableUnderline', 'error', 'filter', 'FormHelperTextProps', 'fullWidth', 'fullWidthInput', 'helperText', 'id', 'InputProps', 'inputRef', 'InputLabelProps', 'label', 'newChipKeyCodes', 'onBeforeAdd', 'onAdd', 'onBlur', 'onDelete', 'onChange', 'onFocus', 'onKeyDown', 'onKeyPress', 'onKeyUp', 'onUpdateInput', 'placeholder', 'alwaysShowPlaceholder', 'required', 'rootRef', 'value', 'variant']);
...
ChipInput.propTypes = {
  ...
  alwaysShowPlaceholder: _propTypes2.default.bool,
